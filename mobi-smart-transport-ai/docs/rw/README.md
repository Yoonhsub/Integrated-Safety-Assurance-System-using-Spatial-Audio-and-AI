...
프로젝트 최상위 `README.md`는 외부인이 프로젝트의 목적, 문제의식, 전체 구조, 현재 검증 상태, V2 방향을 처음 이해하기 위한 거시적 소개 문서입니다.

이 `docs/rw/README.md`는 팀원이 실제 V2 작업을 시작할 때 보는 작업 안내 문서입니다. V2 세부 섹션, 담당자별 목표, 완료 기준은 `docs/rw/V2_SECTION_PLAN.md`를 기준으로 확인합니다.
